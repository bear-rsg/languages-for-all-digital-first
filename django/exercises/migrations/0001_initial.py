...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sentence_source', models.TextField(blank=True, help_text='Provide an original source sentence in one language, which will be translated below. Optional if supplying audio instead, otherwise required', null=True)),
