...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('translation_source_text', models.TextField(blank=True, help_text='Optional if provided source image instead, otherwise required', null=True)),
                ('translation_source_image', models.ImageField(blank=True, help_text='Optional if provided source text instead, otherwise required', null=True, upload_to='exercises-exerciseformat-translation')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sentence_translated_extra_words', models.TextField(blank=True, help_text='(Optional) Include extra words to show as options to make the exercise more challenging. Separate words with a space, e.g. "car apple tree"', null=True, verbose_name='target text extra words')),
                ('correct_answer_feedback', models.TextField(blank=True, help_text='(Optional) Provide feedback about the correct answer (if relevant) to help aid student learning', null=True)),
                ('order', models.IntegerField(blank=True, help_text="(Optional) Specify the order you'd like this item to appear on the exercise page. Leave blank to order automatically.", null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('source', models.TextField(blank=True, help_text='A sentence for the user to translate, either in English or the language being taught. Optional if supplying audio instead, otherwise required', null=True)),
